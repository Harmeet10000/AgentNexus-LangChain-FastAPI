...
- [x] 2. Implement DTO layer and validation
  - [x] 2.1 Create request/response DTOs
  ...
  - [x] 2.2 Create response envelope for API
    - Implement `dto/response.py`: `APIResponse[CreditGrantResponse]` etc.
    - Use `APIResponse[T]` from `app/shared/response_type.py`
    - _Requirements: All API endpoints_

- [x] 3. Implement repository layer with dual-method pattern
  - [x] 3.1 Implement UserCredit repository
  ...
  - [x] 3.2 Implement CreditConsumption repository
  ...
  - [x] 3.3 Integrate with AuditLog repository
...
- [x] 4. Implement core service layer - Credit Service
  - [x] 4.1 Implement Credit Service (part 1: grant and balance)
  ...
  - [x] 4.2 Implement Credit Service (part 2: consumption)
  ...
  - [x] 4.3 Implement Credit Service (part 3: history and expiration)
  ...
  - [x] 4.4 Implement Credit Service (part 4: proration integration)
...
- [x] 5. Implement Razorpay API client integration
  - [x] 5.1 Create Credit-specific Razorpay integration
...
- [x] 6. Implement FastAPI routers
  - [x] 6.1 Create Admin/Portal credit router
  ...
  - [x] 6.2 Create System-Internal credit router
  ...
  - [x] 6.3 Wire credit routers into main application
...
- [x] 7. Implement background jobs (Celery)
  - [x] 7.1 Create daily credit expiration job
  ...
  - [x] 7.2 Create credit reconciliation job
...
- [x] 8. Implement lifespan and dependency injection
  - [x] 8.1 Configure lifespan for credit repositories
...
- [x] 9. Implement comprehensive error handling
  ...
  - [x] 9.2 Add exception handling in credit routers
...
- [x] 10. Implement audit logging integration
  - [x] 10.1 Add audit logging to all credit operations
...
- [x] 11. Implement comprehensive property-based tests
  - [x] 11.1 Write property test for Property 1: Ledger Integrity
  ...
  - [x] 11.2 Write property test for Property 2: Transactional Atomicity
  ...
  - [x] 11.3 Write property test for Property 3: Rollback on Payment Failure
  ...
  - [x] 11.4 Write property test for Property 4: Status Transition Integrity
  ...
  - [x] 11.5 Write property test for Property 5: Consumption Order Correctness
  ...
  - [x] 11.6 Write property test for Property 6: Expiration Exclusion
  ...
  - [x] 11.7 Write property test for Property 7: GST Compliance
  ...
  - [x] 11.8 Write property test for Property 8: Balance Calculation
...
- [x] 12. Implement unit tests
  - [x] 12.1 Write unit tests for Credit Service grant operations
  ...
  - [x] 12.2 Write unit tests for Credit Service consumption operations
  ...
  - [x] 12.3 Write unit tests for Credit Service balance operations
  ...
  - [x] 12.4 Write unit tests for Credit Service history operations
  ...
  - [x] 12.5 Write unit tests for repositories
...
- [x] 13. Implement integration tests
  - [x] 13.1 Write integration test for credit grant flow
  ...
  - [x] 13.2 Write integration test for credit consumption flow
  ...
  - [x] 13.3 Write integration test for daily expiration job
  ...
  - [x] 13.4 Write integration test for proration credit integration
...
- [x] 14. Checkpoint - Core functionality complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Add configuration and settings
  - [x] 15.1 Add credit settings to configuration
