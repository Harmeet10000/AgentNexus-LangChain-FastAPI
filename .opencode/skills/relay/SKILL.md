...
**Never run a leg yourself.** The value is in the independence: a scout's report you wrote yourself is just your own assumption with a citation stapled to it. If a leg fails to dispatch, report that and stop — do not substitute.
