"""MCP observability — Prometheus metrics and observer functions.

Metrics are registered on the shared project registry so they appear
on the /metrics endpoint alongside application metrics.
"""

from prometheus_client import Counter, Gauge, Histogram

from app.middleware.server_middleware import PROJECT, metrics_registry
