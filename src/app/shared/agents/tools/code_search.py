...
def get_code_search_tools(redis_client: Redis, zoekt_url: str) -> list[BaseTool]:
    ...
    @tool(
        args_schema=RipgrepSearchRequest,
        handle_tool_error=True,
        handle_validation_error=build_validation_error_handler(RipgrepSearchRequest),
    )
    ...
    @tool(
        args_schema=ShadowZoektSearchRequest,
        handle_tool_error=True,
        handle_validation_error=build_validation_error_handler(ShadowZoektSearchRequest),
    )
