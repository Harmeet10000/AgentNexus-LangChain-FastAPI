...
from app.features.billing.credits.routers.credit_admin_router import router as credit_admin_router
from app.features.billing.credits.routers.credit_internal_router import (
    router as credit_internal_router,
)
from app.features.billing.dunning.router import router as dunning_router
from app.features.billing.invoices.router import router as invoices_router
from app.features.billing.payments.router import router as payments_router
from app.features.billing.plans.router import router as plans_router
from app.features.billing.subscriptions.router import router as subscriptions_router
from app.features.billing.webhooks.router import router as webhooks_router
...
v2_router.include_router(crawler_router)
