...
class Settings(BaseSettings):
    ...
    BILLING_SELLER_NAME: str = Field(default="")
    BILLING_SELLER_ADDRESS_LINE1: str = Field(default="")
    BILLING_SELLER_ADDRESS_LINE2: str = Field(default="")
    BILLING_SELLER_CITY: str = Field(default="")
    BILLING_SELLER_STATE: str = Field(default="")
    BILLING_SELLER_PINCODE: str = Field(default="")
    BILLING_SELLER_EMAIL: str = Field(default="")
    BILLING_SELLER_PHONE: str = Field(default="")
