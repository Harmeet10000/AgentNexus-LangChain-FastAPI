...
from app.features.billing.models import AuditLog, Subscription, SubscriptionStatus
...
if TYPE_CHECKING:
    ...
    from app.features.billing.models import Subscription as SubscriptionModel
