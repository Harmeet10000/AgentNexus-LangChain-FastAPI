...
from app.features.billing.dto import PlanCreateDTO, PlanResponse, PlanUpdateDTO
...
async def list_plans(
    ...
    if isinstance(result, APIResponse):
        return cast("APIResponse[list[PlanResponse]]", result)
...
async def get_plan(
    ...
    if isinstance(result, APIResponse):
        return cast("APIResponse[PlanResponse]", result)
