...
from app.features.billing.subscriptions.model import SubscriptionStatus
from app.features.billing.webhooks.model import (
    WebhookEvent,
    WebhookEventStatus,
    WebhookEventType,
)
...
if TYPE_CHECKING:
    ...
    from app.features.billing.webhooks.repository import WebhookEventRepository
